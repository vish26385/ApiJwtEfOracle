...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ApiJwtEfOracle", Version = "v1" });
...
builder.Services.AddDbContext<AppDbContext>(options => options.UseOracle(builder.Configuration.GetConnectionString("ConnectionString")));
